...
namespace CryptoTradeLap.Models
{
    ...
    public partial class CryptoTraderEntities : DbContext
    {
        ...
        public virtual ObjectResult<usp_verifizierung_Result> usp_verifizierung(Nullable<int> userId)
        {
            var userIdParameter = userId.HasValue ?
                new ObjectParameter("userId", userId) :
                new ObjectParameter("userId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_verifizierung_Result>("usp_verifizierung", userIdParameter);
        }
    }
}
